...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22635__auto__,writer__22636__auto__,opt__22637__auto__){
return cljs.core._write.call(null,writer__22636__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__23631 = o;
(G__23631[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__23632__delegate = function (args){
...
while (G__23633__i < G__23633__a.length) {G__23633__a[G__23633__i] = arguments[G__23633__i + 0]; ++G__23633__i;}
  args = new cljs.core.IndexedSeq(G__23633__a,0);
} 
return G__23632__delegate.call(this,args);};
G__23632.cljs$lang$maxFixedArity = 0;
G__23632.cljs$lang$applyTo = (function (arglist__23634){
var args = cljs.core.seq(arglist__23634);
return G__23632__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__22017__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__22017__auto__){
var and__22017__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__22017__auto____$1){
var and__22017__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__22017__auto____$2)){
return (jsprops["hasOwnProperty"])("value");
} else {
return and__22017__auto____$2;
}
} else {
return and__22017__auto____$1;
}
} else {
...
var G__23639 = jsprops;
(G__23639["defaultValue"] = value);

(G__23639["onChange"] = ((function (G__23639,v,value,on_change){
return (function (p1__23637_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23637_SHARP_);
});})(G__23639,v,value,on_change))
);
...
var vec__23644 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23644,(0),null);
var id = cljs.core.nth.call(null,vec__23644,(1),null);
var class$ = cljs.core.nth.call(null,vec__23644,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___23647 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___23647 == null)){
} else {
var key_23648 = temp__4661__auto___23647;
(jsprops["key"] = key_23648);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23650 = (new reagent.impl.template.NativeWrapper());
(G__23650["name"] = c);
...
var len__23099__auto___23656 = arguments.length;
var i__23100__auto___23657 = (0);
while(true){
if((i__23100__auto___23657 < len__23099__auto___23656)){
args__23106__auto__.push((arguments[i__23100__auto___23657]));

var G__23658 = (i__23100__auto___23657 + (1));
i__23100__auto___23657 = G__23658;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__23107__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23654){
var G__23655 = cljs.core.first.call(null,seq23654);
var seq23654__$1 = cljs.core.next.call(null,seq23654);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23655,seq23654__$1);
});
...
break;
default:
var G__23662 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23662;
continue;
...
var n__22944__auto___23665 = a.length;
var i_23666 = (0);
while(true){
if((i_23666 < n__22944__auto___23665)){
(a[i_23666] = reagent.impl.template.as_element.call(null,(a[i_23666])));
...
var a = cljs.core.into_array.call(null,s);
var n__22944__auto___23668 = a.length;
var i_23669 = (0);
while(true){
if((i_23669 < n__22944__auto___23668)){
var val_23670 = (a[i_23669]);
if((cljs.core.vector_QMARK_.call(null,val_23670)) && ((reagent.impl.template.key_from_vec.call(null,val_23670) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23669] = reagent.impl.template.as_element.call(null,val_23670));
...
var ctx = {};
var vec__23673 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23673,(0),null);
var derefed = cljs.core.nth.call(null,vec__23673,(1),null);
...
var G__23675 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23675) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23675){
...
//# sourceMappingURL=template.js.map?rel=1467676219628